...
func (h *Handler) adminSignIn(c *gin.Context) {
	...
	res, err := h.usecase.Admins.SignIn(c.Request.Context(), usecase.SchoolSignInInput{
		Email:    inp.Email,
...
func (h *Handler) adminRefresh(c *gin.Context) {
	...
	res, err := h.usecase.Admins.RefreshTokens(c.Request.Context(), school.ID, inp.Token)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminCreateCourse(c *gin.Context) {
	...
	id, err := h.usecase.Courses.Create(c.Request.Context(), school.ID, inp.Name)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminGetAllCourses(c *gin.Context) {
	...
	courses, err := h.usecase.Admins.GetCourses(c.Request.Context(), school.ID)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminGetCourseById(c *gin.Context) {
	...
	course, err := h.usecase.Admins.GetCourseById(c.Request.Context(), school.ID, id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
	...
	modules, err := h.usecase.Modules.GetByCourseId(c.Request.Context(), course.ID)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminUpdateCourse(c *gin.Context) {
	...
	if err := h.usecase.Courses.Update(c.Request.Context(), usecase.UpdateCourseInput{
		CourseID:    idParam,
...
func (h *Handler) adminDeleteCourse(c *gin.Context) {
	...
	if err := h.usecase.Courses.Delete(c.Request.Context(), school.ID, id); err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminCreateModule(c *gin.Context) {
	...
	moduleId, err := h.usecase.Modules.Create(c.Request.Context(), usecase.CreateModuleInput{
		SchoolID: school.ID.Hex(),
		CourseID: id,
		Name:     inp.Name,
...
func (h *Handler) adminUpdateModule(c *gin.Context) {
	...
	if err := h.usecase.Modules.Update(c.Request.Context(), usecase.UpdateModuleInput{
		ID:        id,
		SchoolID:  school.ID.Hex(),
		Name:      inp.Name,
		Position:  inp.Position,
...
func (h *Handler) adminDeleteModule(c *gin.Context) {
	...
	err = h.usecase.Modules.Delete(c.Request.Context(), school.ID, id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminGetLessons(c *gin.Context) {
	...
	module, err := h.usecase.Modules.GetWithContent(c.Request.Context(), moduleId)
	if err != nil {
...
func (h *Handler) adminCreateLesson(c *gin.Context) {
	...
	lessonId, err := h.usecase.Lessons.Create(c.Request.Context(), usecase.AddLessonInput{
		ModuleID: id,
		Name:     inp.Name,
		Position: inp.Position,
		SchoolID: school.ID.Hex(),
...
func (h *Handler) adminGetLessonById(c *gin.Context) {
	...
	lesson, err := h.usecase.Lessons.GetById(c.Request.Context(), id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminUpdateLesson(c *gin.Context) {
	...
	if err := h.usecase.Lessons.Update(c.Request.Context(), usecase.UpdateLessonInput{
		LessonID:  id,
		Name:      inp.Name,
		Content:   inp.Content,
		Position:  inp.Position,
...
func (h *Handler) adminDeleteLesson(c *gin.Context) {
	...
	err = h.usecase.Lessons.Delete(c.Request.Context(), school.ID, id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminCreatePackage(c *gin.Context) {
	...
	moduleId, err := h.usecase.Packages.Create(c.Request.Context(), usecase.CreatePackageInput{
		SchoolID: school.ID.Hex(),
		CourseID: id,
		Name:     inp.Name,
		Modules:  inp.Modules,
...
func (h *Handler) adminGetAllPackages(c *gin.Context) {
	...
	pkg, err := h.usecase.Packages.GetByCourse(c.Request.Context(), id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, "invalid id param")
...
func (h *Handler) adminGetPackageById(c *gin.Context) {
	...
	pkg, err := h.usecase.Packages.GetById(c.Request.Context(), id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, "invalid id param")
...
func (h *Handler) adminUpdatePackage(c *gin.Context) {
	...
	if err := h.usecase.Packages.Update(c.Request.Context(), usecase.UpdatePackageInput{
		ID:       id,
		SchoolID: school.ID.Hex(),
		Name:     inp.Name,
		Modules:  inp.Modules,
...
func (h *Handler) adminDeletePackage(c *gin.Context) {
	...
	err = h.usecase.Packages.Delete(c.Request.Context(), school.ID, id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, "invalid id param")
...
func (h *Handler) adminCreateOffer(c *gin.Context) {
	...
	id, err := h.usecase.Offers.Create(c.Request.Context(), usecase.CreateOfferInput{
		SchoolID:    school.ID,
		Name:        inp.Name,
		Description: inp.Description,
...
func (h *Handler) adminGetAllOffers(c *gin.Context) {
	...
	offers, err := h.usecase.Offers.GetAll(c.Request.Context(), school.ID)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
	...
	for i, offer := range offers {
		pkgs, err := h.usecase.Packages.GetByIds(c.Request.Context(), offer.PackageIDs)
		if err != nil {
			newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminGetOfferById(c *gin.Context) {
	...
	offer, err := h.usecase.Offers.GetById(c.Request.Context(), id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminUpdateOffer(c *gin.Context) {
	...
	updateInput := usecase.UpdateOfferInput{
		ID:          id,
		SchoolID:    school.ID.Hex(),
		Name:        inp.Name,
		Description: inp.Description,
	...
	if err := h.usecase.Offers.Update(c.Request.Context(), updateInput); err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminDeleteOffer(c *gin.Context) {
	...
	err = h.usecase.Offers.Delete(c.Request.Context(), school.ID, id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminCreatePromocode(c *gin.Context) {
	...
	id, err := h.usecase.PromoCodes.Create(c.Request.Context(), usecase.CreatePromoCodeInput{
		SchoolID:           school.ID,
		Code:               inp.Code,
...
func (h *Handler) adminGetPromocodes(c *gin.Context) {
	...
	promocodes, err := h.usecase.PromoCodes.GetBySchool(c.Request.Context(), school.ID)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
	...
	for i, promocode := range promocodes {
		offers, err := h.usecase.Offers.GetByIds(c.Request.Context(), promocode.OfferIDs)
		if err != nil {
			newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminGetPromocodeById(c *gin.Context) {
	...
	promoCode, err := h.usecase.PromoCodes.GetById(c.Request.Context(), school.ID, id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminUpdatePromocode(c *gin.Context) {
	...
	if err := h.usecase.PromoCodes.Update(c.Request.Context(), domain.UpdatePromoCodeInput{
		ID:                 id,
		SchoolID:           school.ID,
		Code:               inp.Code,
		DiscountPercentage: inp.DiscountPercentage,
...
func (h *Handler) adminDeletePromocode(c *gin.Context) {
	...
	if err := h.usecase.PromoCodes.Delete(c.Request.Context(), school.ID, id); err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminUpdateSchoolSettings(c *gin.Context) {
	...
	if err := h.usecase.Schools.UpdateSettings(c.Request.Context(), school.ID, updateInput); err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminConnectFondy(c *gin.Context) {
	...
	if err := h.usecase.Schools.ConnectFondy(c.Request.Context(), usecase.ConnectFondyInput{
		SchoolID:         school.ID,
...
func (h *Handler) adminConnectSendPulse(c *gin.Context) {
	...
	if err := h.usecase.Schools.ConnectSendPulse(c.Request.Context(), usecase.ConnectSendPulseInput{
		SchoolID: school.ID,
		ID:       inp.ID,
		Secret:   inp.Secret,
		ListID:   inp.ListID,
...
func (h *Handler) adminGetOrders(c *gin.Context) {
	...
	orders, count, err := h.usecase.Orders.GetBySchool(c.Request.Context(), school.ID, query)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminUpdateOrderStatus(c *gin.Context) {
	...
	if err := h.usecase.Orders.SetStatus(c.Request.Context(), id, inp.Status); err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
