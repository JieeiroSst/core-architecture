...
func (h *Handler) adminGetStudents(c *gin.Context) {
	...
	students, count, err := h.usecase.Students.GetBySchool(c.Request.Context(), school.ID, query)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminGetStudentById(c *gin.Context) {
	...
	student, err := h.usecase.Students.GetById(c.Request.Context(), school.ID, id)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminCreateStudent(c *gin.Context) {
	...
	student, err := h.usecase.Admins.CreateStudent(c.Request.Context(), inp)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminManageOfferPermission(c *gin.Context) {
	...
	offer, err := h.usecase.Offers.GetById(c.Request.Context(), offerId)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
	...
	if inp.Available {
		if err := h.usecase.Students.GiveAccessToOffer(c.Request.Context(), studentId, offer); err != nil {
			newResponse(c, http.StatusInternalServerError, err.Error())
	...
	if err := h.usecase.Students.RemoveAccessToOffer(c.Request.Context(), studentId, offer); err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminUpdateStudent(c *gin.Context) {
	...
	if err := h.usecase.Admins.UpdateStudent(c.Request.Context(), inp); err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) adminDeleteStudent(c *gin.Context) {
	...
	if err := h.usecase.Admins.DeleteStudent(c.Request.Context(), school.ID, studentId); err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
