...
func (h *Handler) userSignUp(c *gin.Context) {
	...
	if err := h.usecase.Users.SignUp(c.Request.Context(), usecase.UserSignUpInput{
		Name:     inp.Name,
		Email:    inp.Email,
		Phone:    inp.Phone,
...
func (h *Handler) userSignIn(c *gin.Context) {
	...
	res, err := h.usecase.Users.SignIn(c.Request.Context(), usecase.UserSignInInput{
		Email:    inp.Email,
		Password: inp.Password,
	})
	if err != nil {
...
func (h *Handler) userRefresh(c *gin.Context) {
	...
	res, err := h.usecase.Users.RefreshTokens(c.Request.Context(), inp.Token)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
...
func (h *Handler) userVerify(c *gin.Context) {
	...
	if err := h.usecase.Users.Verify(c.Request.Context(), id, code); err != nil {
...
func (h *Handler) userCreateSchool(c *gin.Context) {
	...
	school, err := h.usecase.Users.CreateSchool(c.Request.Context(), id, inp.Name)
	if err != nil {
		newResponse(c, http.StatusInternalServerError, err.Error())
